...
import { loadPosts, loadMorePosts, likePost, disLikePost, toggleExpandedPost, addPost,updatePost ,deletePost } from './actions';
...
const [updatePostId, setUpdatedPostId] = useState(undefined);
...
const updatePost = id => {setUpdatedPostId(id);};
