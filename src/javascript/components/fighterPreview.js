...
const info = createElement({tagName: 'div',className: 'fighter-preview___info'});
const name = createElement({tagName:'h2',className: 'fighter-preview___info-name'});
...
const element = createElement({tagName: 'div',className: 'fighter-preview___info-row'});
